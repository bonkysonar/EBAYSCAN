...
export const retailArbitrageSourceCatalog: RetailArbitrageSource[] = [
  ...
  source({
    ...
    baseUrl: "https://www.popmarket.com/collections/deals",
    country: "US",
    sourceType: "distributor_network",
    crawlType: "retailer",
    priority: 1,
  ...
  source({
    ...
    displayName: "WowHD",
    domain: "wowhd.co.uk",
    baseUrl: "https://www.wowhd.co.uk/music/vinyl",
    country: "US",
    sourceType: "distributor_network",
    crawlType: "retailer",
    priority: 1,
  ...
  source({
    ...
    baseUrl: "https://www.moviesunlimited.com/search?options%5Bprefix%5D=last&pf_m_%3A%3Acustom%3A%3Aformat=LP&q=vinyl",
    country: "US",
    sourceType: "distributor_network",
    crawlType: "retailer",
    priority: 1,
    ...
    ...strictPublicSourceRules,
    group: "Distributor networks",
    notes: "Migrated storefront: current public LP-filtered search replaces removed /music/vinyl. Bounded visible-browser catalogs retain unknown artists for research rather than inferring them.",
    salePathHints: commonSalePathHints,
  }),
  source({
    id: "udiscover-music",
  ...
  source({
    ...
    baseUrl: "https://thesoundofvinyl.us/collections/end-of-summer-sale",
    country: "US",
    sourceType: "major_label_store",
    crawlType: "shopify-store",
    priority: 1,
    ...
    ...strictPublicSourceRules,
    group: "Major label stores",
    notes: "UMG direct store; End of Summer Sale is the current official collection. Former half-price collection was removed; do not reuse its discount.",
    salePathHints: ["/collections/end-of-summer-sale", ...commonSalePathHints],
  }),
  source({
    id: "blue-note-store",
  ...
  source({
    ...
    ...normalSourceRules,
    group: "Major label stores",
    notes: "Current official store; the former /collections/vinyl route redirects to an obsolete empty collection.",
    salePathHints: ["/collections/garage-sale", "/collections/july-4th-vinyl-sale", ...commonSalePathHints],
  }),
  source({
    ...
    ...normalSourceRules,
    group: "Major label stores",
    notes: "Current official Capitol Music storefront; preserve variant identity for exclusives.",
    salePathHints: ["/collections/4th-of-july-sale", "/collections/spring-sale", ...commonSalePathHints],
  }),
  source({
  ...
  source({
    ...
    ...normalSourceRules,
    group: "Major label stores",
    notes: "Current official EMI storefront; UK landed cost needs FX, shipping, VAT/duty risk and damage reserve.",
    salePathHints: commonSalePathHints,
  }),
  source({
    id: "recordstore-uk",
  ...
  source({
    ...
    baseUrl: "https://townsendmusic.store/products/special/new-releases",
    country: "UK",
    sourceType: "uk_retailer",
    crawlType: "shopify-store",
    priority: 1,
  ...
  source({
    ...
    ...strictPublicSourceRules,
    group: "UK / international retailers",
    notes: "Public Shopify catalog is available; require a strict threshold plus landed-cost reserve.",
    salePathHints: commonSalePathHints,
  }),
  source({
    id: "hmv",
  ...
  source({
    ...
    baseUrl: "https://www.roughtrade.com/en-us/search?sortBy=most_relevant&maxPrice=15&format=LP&sale=true",
    country: "UK/US",
    sourceType: "uk_retailer",
    crawlType: "retailer",
    priority: 1,
    ...
    ...normalSourceRules,
    group: "UK / international retailers",
    notes: "Current canonical sale route; regional availability and landed cost still require validation.",
    salePathHints: commonSalePathHints,
  }),
  ...[
    ["norman-records", "Norman Records", "normanrecords.com", "https://www.normanrecords.com/cheap"],
    ["resident-music", "Resident Music", "resident-music.com", "https://www.resident-music.com/department.aspx?dept=vinyl"],
    ["banquet-records", "Banquet Records", "banquetrecords.com", "https://www.banquetrecords.com/new-in"],
    ["juno", "Juno", "juno.co.uk", "https://www.juno.co.uk/all/back-cat/vinyl/"],
    ["bleep", "Bleep", "bleep.com", "https://bleep.com/format/vinyl"],
    ["plastic-head-megastore", "Plastic Head Megastore", "plastichead.com", "https://www.plastichead.com/music/vinyl/new"],
    ["zavvi", "Zavvi", "zavvi.com", "https://www.zavvi.com/merch-vinyl.list"],
    ["assai-records", "Assai Records", "assai.co.uk", "https://assai.co.uk/collections/a-z-vinyl-offers"],
    ["crash-records", "Crash Records", "crashrecords.co.uk", "https://www.crashrecords.co.uk/collections/vinyl"],
    ["sister-ray", "Sister Ray", "sisterray.co.uk", "https://sisterray.co.uk/collections/autumn-sale"],
    ["vinilo", "Vinilo", "vinilo.co.uk", "https://vinilo.co.uk/collections/sale"],
    ...
    ["sounds-of-the-universe", "Sounds of the Universe", "soundsoftheuniverse.com", "https://soundsoftheuniverse.com/browse/c-music/f-new-lp/y-/o-all/b-1/v-list/s-hide"],
  ...
  source({
    ...
    baseUrl: "https://www.plaidroomrecords.com/collections/discounted",
    country: "US",
    ...
    ...normalSourceRules,
    group: "US retailers",
    notes: "Current Discounted collection replaces the removed sale-vinyl route.",
    salePathHints: commonSalePathHints,
  }),
  source({
    id: "lunchbox-records",
  ...
  ...[
    ...
    ["light-in-the-attic", "Light in the Attic", "lightintheattic.net", "https://lightintheattic.net/collections/sale"],
    ["mondo", "Mondo", "mondoshop.com", "https://mondoshop.com/collections/new-vinyl-records"],
  ].map(([id, displayName, domain, baseUrl]) =>
    source({
      id,
      displayName,
  ...
  ...[
    ["ebay-purchase", "eBay", "ebay.com", "https://www.ebay.com/sch/i.html?_nkw=vinyl+record&_sacat=176985&LH_ItemCondition=1000&LH_BIN=1"],
    ...
    source({
      ...
      crawlType: id === "ebay-purchase" ? "marketplace" : "retailer",
      priority: id === "ebay-purchase" ? 1 : 3,
      saleLikelihood: id === "ebay-purchase" ? "low" : "medium",
      ...strictMarketplaceRules,
      group: "US retailers",
      notes:
        id === "ebay-purchase"
          ? "Official Browse API purchase discovery for new fixed-price vinyl; requires eBay OAuth and active asking prices are not sold evidence."
          : displayName === "Urban Outfitters"
            ? "Noisy public source; boost exclusive variants only."
            : "Noisy public source; require strict margin and match confidence.",
      salePathHints: id === "ebay-purchase" ? [] : commonSalePathHints,
    }),
  ),
  ...[
  ...
  ...[
    ["secretly-store", "Secretly Store", "secretlystore.com", "https://secretlystore.com/collections/vinyl"],
    ...
    ["polyvinyl-records", "Polyvinyl Records", "polyvinylrecords.com", "https://www.polyvinylrecords.com/collections/everything?filter.v.m.custom.general_format=Vinyl&filter.v.m.display.option=active&filter.v.m.display.option=active-no-notifications&sort_by=title-ascending"],
    ...
    ["matador-records", "Matador Records", "matadorrecords.com", "https://matadorrecords.com/collections/matador-classics"],
    ["beggars", "Beggars Banquet", "beggarsbanquetrecords.com", "https://shop.beggarsbanquetrecords.com/new-releases"],
    ...
    ["daptone-records", "Daptone Records", "daptonerecords.com", "https://shopdaptonerecords.com/collections/lps"],
    ["colemine-records", "Colemine Records", "coleminerecords.com", "https://www.coleminerecords.com/collections/lp"],
  ...
  ...[
    ...
    ["pure-noise-records", "Pure Noise Records", "purenoise.net", "https://purenoise.merchnow.com/collections/best-selling-vinyl"],
    ...
    ["equal-vision", "Equal Vision", "equalvision.com", "https://equalvision.com/collections/vinyl-lp"],
    ["sumerian-records", "Sumerian Records", "sumerianrecords.com", "https://sumerianrecords.com/collections/vinyl-records"],
    ["rise-records", "Rise Records", "riserecords.com", "https://riserecords.com/collections/vinyl-lp"],
    ["century-media", "Century Media", "centurymedia.com", "https://centurymedia.store/collections/vinyl"],
    ["napalm-records-america", "Napalm Records America", "napalmrecords.us", "https://napalmrecords.us/collections/vinyl"],
    ["season-of-mist", "Season of Mist", "season-of-mist.com", "https://shopusa.season-of-mist.com/collections/on-sale"],
